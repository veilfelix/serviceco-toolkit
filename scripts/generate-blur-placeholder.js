 ...
 *
 * Usage:
 *   node scripts/generate-blur-placeholder.js https://example.com/image.jpg
 *
...
async function generateBlurPlaceholder(imageUrl) {
  try {
...
if (!imageUrl) {
  ...
  console.error('Usage: node scripts/generate-blur-placeholder.js https://example.com/image.jpg')
  process.exit(1)
}
